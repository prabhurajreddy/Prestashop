<?php /* Smarty version Smarty-3.1.11, created on 2015-02-15 02:40:05
         compiled from "/home/student/public_html/prestashop/themes/prestashop/authentication.tpl" */ ?>
<?php /*%%SmartyHeaderCode:27807554254df96854eec68-37575411%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bfbce8b1513ab19fc1282b631022c7fcdcf21b1a' => 
    array (
      0 => '/home/student/public_html/prestashop/themes/prestashop/authentication.tpl',
      1 => 1372306200,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '27807554254df96854eec68-37575411',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54df9685bf5963_76171120',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54df9685bf5963_76171120')) {function content_54df9685bf5963_76171120($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/home/student/public_html/prestashop/tools/smarty/plugins/modifier.escape.php';
?>
...
<?php $_smarty_tpl->_capture_stack[0][] = array('path', null, null); ob_start(); ?><?php if (!isset($_smarty_tpl->tpl_vars['email_create']->value)){?><?php echo smartyTranslate(array('s'=>'Login'),$_smarty_tpl);?>
<?php }else{ ?><a rel="nofollow" href="<?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('authentication.php',true);?>
...
.</h4>
			<p class="text">
				...
				<span><input type="text" id="email_create" name="email_create" value="<?php if (isset($_POST['email_create'])){?><?php echo smarty_modifier_escape(stripslashes($_POST['email_create']), 'htmlall', 'UTF-8');?>
...
" method="post" id="login_form" class="std">
		<fieldset>
			...
			<p class="text">
				...
				<span><input type="text" id="email" name="email" value="<?php if (isset($_POST['email'])){?><?php echo smarty_modifier_escape(stripslashes($_POST['email']), 'htmlall', 'UTF-8');?>
<?php }?>" class="account_input" /></span>
			</p>
			<p class="text">
				<label for="passwd"><?php echo smartyTranslate(array('s'=>'Password'),$_smarty_tpl);?>
</label>
				<span><input type="password" id="passwd" name="passwd" value="<?php if (isset($_POST['passwd'])){?><?php echo smarty_modifier_escape(stripslashes($_POST['passwd']), 'htmlall', 'UTF-8');?>
<?php }?>" class="account_input" /></span>
			</p>
			<p class="submit">
				<?php if (isset($_smarty_tpl->tpl_vars['back']->value)){?><input type="hidden" class="hidden" name="back" value="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['back']->value, 'htmlall', 'UTF-8');?>
...
"><?php echo smartyTranslate(array('s'=>'Forgot your password?'),$_smarty_tpl);?>
	...
	<?php if (isset($_smarty_tpl->tpl_vars['inOrderProcess']->value)&&$_smarty_tpl->tpl_vars['inOrderProcess']->value&&$_smarty_tpl->tpl_vars['PS_GUEST_CHECKOUT_ENABLED']->value){?>
		<form action="<?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('authentication.php',true);?>
?back=<?php echo $_smarty_tpl->tpl_vars['back']->value;?>
...
<?php }?>">
					...
					<p class="radio required">
						...
						<label for="id_gender2" class="top"><?php echo smartyTranslate(array('s'=>'Mrs.'),$_smarty_tpl);?>
</label>
					</p>
					<p class="required text">
						<label for="firstname"><?php echo smartyTranslate(array('s'=>'First name'),$_smarty_tpl);?>
</label>
						<input type="text" class="text" id="firstname" name="firstname" onchange="$('#customer_firstname').val($(this).val());" value="<?php if (isset($_POST['firstname'])){?><?php echo $_POST['firstname'];?>
<?php }?>">
...
<?php }?>">
					...
					<p class="required text">
						...
						<input type="text" class="text" id="lastname" name="lastname" onchange="$('#customer_lastname').val($(this).val());" value="<?php if (isset($_POST['lastname'])){?><?php echo $_POST['lastname'];?>
<?php }?>">
